...
const file_proto_kv_proto_rawDesc = "" +
	...
	"\rKeyValueStore\x12#\n" +
	"\x05Store\x12\f.kv.KeyValue\x1a\f.kv.Response\x12\x1e\n" +
	"\bRetrieve\x12\a.kv.Key\x1a\t.kv.Value\x12\x1f\n" +
	"\x06Delete\x12\a.kv.Key\x1a\f.kv.ResponseB7Z5github.com/mbasha/grpc-kv-store/kv-grpc-service/protob\x06proto3"
...
var file_proto_kv_proto_goTypes = []any{
	...
	(*Key)(nil),      // 1: kv.Key
	(*Value)(nil),    // 2: kv.Value
	(*Response)(nil), // 3: kv.Response
}
var file_proto_kv_proto_depIdxs = []int32{
	0, // 0: kv.KeyValueStore.Store:input_type -> kv.KeyValue
	1, // 1: kv.KeyValueStore.Retrieve:input_type -> kv.Key
	1, // 2: kv.KeyValueStore.Delete:input_type -> kv.Key
	3, // 3: kv.KeyValueStore.Store:output_type -> kv.Response
	2, // 4: kv.KeyValueStore.Retrieve:output_type -> kv.Value
	3, // 5: kv.KeyValueStore.Delete:output_type -> kv.Response
